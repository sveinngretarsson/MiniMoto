/*
 * lab6Example.c
  	  	  From Texas Austin MC course
  	  	  URL : http://users.ece.utexas.edu/~valvano/Volume1/E-Book/C6_MicrocontrollerPorts.htm
 *
 *  Created on: May 10, 2014
 *      Author: Sveinn Gretarsson
 */
//#include <stdint.h>
#include "tm4c123ge6pm.h" // Pin declerations and std library includes.
